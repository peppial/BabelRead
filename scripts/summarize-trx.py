...
import json
import sys
# parse_trusted_xml below refuses a DOCTYPE, which is the entity-expansion vector here;
# ElementTree never resolves external entities. defusedxml would add a dependency to a
